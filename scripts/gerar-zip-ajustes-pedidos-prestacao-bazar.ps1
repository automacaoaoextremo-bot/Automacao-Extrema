...
$ZipName = "ae-bazar-ajustes-pedidos-prestacao.zip"
$TempDir = Join-Path $env:TEMP "ae-bazar-ajustes-pedidos-prestacao"
...
# Inclui automaticamente SQLs extras relacionados ao Bazar/Sementinha/Prestacao, se existirem
