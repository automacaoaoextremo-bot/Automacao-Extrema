...
$ZipName = "organizacao-em-harmonia-consulente-agenda-contribuicao-$Timestamp.zip"
$OutputZip = Join-Path $ProjectRoot $ZipName
$TempDir = Join-Path $env:TEMP "ae-oh-consulente-agenda-contribuicao-$Timestamp"
...
$items = @(
  ...
  "src\app\solucoes\organizacao-em-harmonia\login",
