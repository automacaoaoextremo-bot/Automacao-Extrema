...
$packageName = "ae-presenca-querida-ajustes-mobile-copy-confirmacao-$timestamp"
...
Write-AE "Copiando arquivos necessários para ajustes mobile, copiar WhatsApp, link sem #confirmacao e confirmação individual/vinculados..."
...
1. Reduzir altura dos cards/links da terceira linha do cabeçalho no mobile.
2. Incluir opção para copiar mensagens de WhatsApp dos convidados.
3. Gerar links de WhatsApp para o início da LP, sem #confirmacao.
4. Melhorar confirmação quando há convidados vinculados:
   - confirmar todos;
   - ou confirmar individualmente cada pessoa do convite;
   - permitir principal confirmar agora e vinculados ficarem pendentes até 19/11/2026.
5. Remover preenchimento indevido do campo "Curiosidade ou recado para a Daniela" quando a pessoa ainda não digitou nada.
6. Reduzir repetição entre bloco "este convite também inclui" e texto de total previsto.
"@
