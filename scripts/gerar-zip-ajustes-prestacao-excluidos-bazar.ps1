...
$ZipName = "ae-bazar-ajustes-prestacao-excluidos.zip"
$TempDir = Join-Path $env:TEMP "ae-bazar-ajustes-prestacao-excluidos"
...
# Inclui automaticamente SQLs extras relacionados ao Bazar/Sementinha/Relatórios, se existirem
...
if (Test-Path $SqlDir) {
    Get-ChildItem $SqlDir -File | Where-Object {
        ...
        $_.Name -like "*prestacao*" -or
        $_.Name -like "*orders*" -or
        $_.Name -like "*payments*"
    } | ForEach-Object {
