...
$packageName = "ae-presenca-querida-ajustes-gerar-convites-apenas-pendentes-$timestamp"
...
Write-AE "Copiando arquivos necessários para ajustar geração de convites personalizados e modelo de WhatsApp..."
...
1. Garantir que o botão "Gerar convites personalizados" gere somente para convites que ainda não estão aprovados.
2. Gerar também para novos convidados incluídos.
3. Regenerar para convidados alterados, desde que o convite ainda não esteja aprovado.
4. Preservar mensagens já aprovadas.
5. Usar novo modelo com espaçamento entre parágrafos:
