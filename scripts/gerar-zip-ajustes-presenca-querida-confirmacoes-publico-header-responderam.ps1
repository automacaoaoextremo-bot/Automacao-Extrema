...
$packageName = "ae-presenca-querida-ajustes-confirmacoes-publico-header-responderam-$timestamp"
...
Write-AE "Copiando arquivos necessários para ajustar cabeçalho fixo e remover card Já responderam..."
...
2. Manter fixo no topo, no mobile, o cabeçalho até a linha "Desenvolvido por Automação Extrema".
3. Mover a informação "Daniela 50 anos • 19/12/2026 • 12h30 às 17h30" para uma segunda linha dentro do cabeçalho fixo, com formatação adequada e responsiva.
4. Retirar essa mesma informação do bloco principal, evitando duplicidade.
5. Remover o card/seção "Já responderam", pois ficou redundante com as listas por status.
6. Manter a tela mobile friendly, sem overflow horizontal e sem ações administrativas.
"@
