export const tucxaTheme = {
  organizationName: "TUCXA",
  fullName: "Templo de Umbanda Caboclo Sete Flexa",
  logoSrc: "/clientes/tucxa/tucxa-logo.jpg",
  primary: "#123D2C",
  primarySoft: "#E9F2E7",
  accent: "#2F6B43",
  cream: "#F7FAF2",
...
export const filhoDaCorrenteFunctions = [
  ...
  { slug: "cavalinho", label: "Cavalinho" },
  { slug: "coordenacao", label: "Coordenação" },
  { slug: "diretoria", label: "Diretoria" },
  { slug: "filho-da-corrente", label: "Filho da Corrente" },
