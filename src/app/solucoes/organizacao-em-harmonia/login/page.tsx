...
export default function OrganizacaoEmHarmoniaLoginPage() {
  ...
  async function onSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    if (authError) {
      setError("Não foi possível entrar. Confira e-mail e senha da Organização em Harmonia.");
      setLoading(false);
      return;
    }
        ...
        <div className="rounded-[2rem] bg-white p-5 shadow-xl ring-1 ring-slate-100 sm:p-7">
          <div className="space-y-3">
            ...
            <p className="text-base leading-7 text-slate-700 sm:text-lg sm:leading-8">
              Acesse para configurar a Base Única, confirmar módulos, organizar Agenda Viva, Atendimento em Harmonia e Corrente em Dia conforme as permissões definidas para a sua organização.
            </p>
          </div>
