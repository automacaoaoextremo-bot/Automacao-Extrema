...
# Execute este script na raiz do projeto Automacao-Extrema
$ProjectRoot = (Get-Location).Path
$Stamp = Get-Date -Format "yyyyMMdd-HHmm"
$TempDir = Join-Path $ProjectRoot "_zip_bni_ae_$Stamp"
$ZipFile = Join-Path $ProjectRoot "automacao-extrema-bni-$Stamp.zip"

Write-Host "Gerando ZIP para ajustes BNI da Automação Extrema..."
...
Write-Host $ZipFile
Write-Host ""
Write-Host "Agora envie este arquivo aqui no chat."