...
-- Evolução 02: garante os valores oficiais de jan-jun/2026 conforme
-- os balancetes enviados pelo Tucxa e elimina cargas ativas concorrentes.
--
-- Fontes:
...
--
-- Migration corretiva e idempotente para a Evolução 02.
-- Mantém a carga oficial com source_type = balancete_pdf_2026 e cancela qualquer
-- outra carga ativa de Jan-Jun/2026 para impedir soma duplicada nos painéis.
...
begin
  ...
  loop
    ...
    values (
      ...
      jsonb_build_object(
        'origin', 'balancetes_oficiais_jan_jun_2026_evolucao_02',
        'loadedAt', now()
      ),
      now()
    )
  ...
  -- Cancela qualquer carga não oficial ativa de janeiro a junho.
  -- Isto também corrige cenários em que uma carga manual/legada permaneceu ativa
  -- junto dos lançamentos oficiais e acabou duplicando os totais.
  ...
  set
    ...
    notes_internal = concat_ws(
      E'\n',
      notes_internal,
      'Substituído/corrigido em 12/08/2026 pela carga oficial dos balancetes em PDF.'
    ),
    updated_at = now()
  where organization_id = org_id
    and competence_month between '2026-01-01'::date and '2026-06-01'::date
    and coalesce(source_type, '') <> 'balancete_pdf_2026'
  ...
  values (
    org_id,
    'balancetes_oficiais_jan_jun_2026_evolucao_02_importados',
    ...
    jsonb_build_object(
      ...
      'origem', 'Balancetes oficiais PDF validados na Evolução 02 em 12/08/2026'
    ),
    'Correção de janeiro a junho de 2026 conforme balancetes oficiais, com cancelamento de cargas não oficiais concorrentes.'
  );
end $$;
